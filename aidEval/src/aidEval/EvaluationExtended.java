...
public class EvaluationExtended extends EvaluationBase implements EvalInterface {
	...
	public void setFinalGrade() {
		...
		//if accuracy doesn't meet the conditions, set similarity grade to 1
		if(accuracy  == 1)
			similarity = 1;
